...
namespace PayPal.iOS
{
	...
	interface PayPalConfiguration : INSCopying
	{
		...
		// @property (assign, readwrite, nonatomic) BOOL disableShakeAnimations;
		[Export("disableShakeAnimations")]
		bool DisableShakeAnimations { get; set; }
	...
	interface PayPalPayment : INSCopying
	{
		...
		// @property (readwrite, copy, nonatomic) NSString * _Nullable payeeEmail;
		[NullAllowed, Export("payeeEmail")]
		string PayeeEmail { get; set; }
